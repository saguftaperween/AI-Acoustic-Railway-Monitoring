...
class StationDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final LatLng stationLocation1 = LatLng(12.8406, 80.1534); // Example: Eiffel Tower coordinates
    final LatLng stationLocation2 =LatLng(13.0827, 80.2707);  // Location 2
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: StationMap(stationLocation1: stationLocation1 , stationLocation2: stationLocation2),  // Custom map widget
            ),
          ],
        ),
      ),
